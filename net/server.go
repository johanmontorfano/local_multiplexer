...
func MakeServer(config *NetConfig) Server {
	return Server {
...
// Allocates a new server mux to the server that will be used when starting the 
// server.
func (srv *Server) MakeHandler(
